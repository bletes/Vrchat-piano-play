...
pydirectinput.PAUSE=0.01 #direct exe
...
##    b=bh-60
##b=29
plt.scatter(range(len(bb)),bb['0'])
plt.plot(range(len(bb)),np.linspace(32,32,len(bb)))
plt.plot(range(len(bb)),np.linspace(92,92,len(bb)))
plt.show()
time.sleep(1)
